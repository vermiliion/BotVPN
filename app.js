...
━━━━━━━━━━━━━━━━━━━━━━
💳 *» Saldo:* \`Rp.${saldo}\`
❇️ *» Trial Bisa 2x Sehari Juragan*
🚀 *» Support Wildcard*
━━━━━━━━━━━━━━━━━━━━━━
🕒 *» Jam:* \`${timeNow}\`
...
async function handleServiceAction(ctx, action) {
  ...
  if (action === 'trial') {
    ...
    keyboard = [
      ...
      [{ text: '♂️ Vmess', callback_data: 'create_vmess' }, { text: '♂️ Vless', callback_data: 'create_vless' }],
      [{ text: '♂️ Trojan', callback_data: 'create_trojan' }, { text: '♂️ Shadowsocks', callback_data: 'create_shadowsocks' }],
      [{ text: '🔙 Kembali', callback_data: 'send_main_menu' }]
    ];
...
function prosesBonusTopUp(user_id, username, original_amount) {
    db.get('SELECT * FROM bonus_config WHERE id = 1', (err, config) => {
        ...
        if (config.enabled && original_amount >= config.min_topup) {
            ...
            db.run('UPDATE users SET saldo = saldo + ? WHERE user_id = ?', [bonus, user_id]);
